...
var ngColumn = function (config, $scope, grid, domUtilityService, $templateCache, $utils) {
    ...
    // self.enableCellEdit = test.enableCellEdit || colDef.enableCellEdit;
...
var ngGrid = function ($scope, options, sortService, domUtilityService, $filter, $templateCache, $utils, $timeout, $parse, $http, $q) {
    ...
    self.configureColumnWidths = function() {
        ...
        // their width test to be out of sync. We can use "originalIndex" on the ngColumns to get hold of the correct setup from columnDefs, but to
        ...
        if (percentArray.length > 0) {
            //If they specificy for maintain column ratios to be false in grid test, then it will remain false. If not specifiied or true, will be true.
