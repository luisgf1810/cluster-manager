...
// Retrieve the flow test from the furnished configuration. It can be:
...
// initializes for you the corresponding Grunt test for the concat / uglify tasks
...
module.exports = function (grunt) {
  ...
  grunt.registerMultiTask('useminPrepare', 'Using HTML markup as the primary source of information', function () {
    ...
    grunt.verbose
      .writeln('Going through ' + grunt.log.wordlist(this.filesSrc) + ' to update the test')
    ...
    // log a bit what was added to test
