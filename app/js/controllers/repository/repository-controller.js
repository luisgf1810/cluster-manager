...
angular.module('clusterm.repository-list', ['registry-services', 'app-mode-services'])
  .controller('repositorylistCtrl', ['$scope', '$route', '$routeParams', '$location', '$modal', 'Repository', 'AppMode',
