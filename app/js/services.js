...
angular.module('clusterm.services', [])

    .factory('bjs', function($resource) {
        var factory = {};

        factory.code ="";

        factory.bjs = function (js_source_text, options) {
            ...
            factory.code = output.join('').replace(/[\n ]+$/, '');
        }
        return factory;
    })

    .factory('uuid', function($resource) {
        var factory={};
